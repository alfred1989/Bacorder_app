        ...
        if($result->num_rows > 0){
            while($row = $result->fetch_assoc()){
                ...
                <tr>
                    ...
                    <td><?php echo $row['Kodtowaru']; ?></td>
                    <td><?php echo $row['EAN']; ?></td>
                    <td><?php echo $row['Nazwatowaru']; ?></td>
                    <td><?php echo $row['Iloscdorealizacji']; ?></td>
                    <td><?php echo $row['Jednostka']; ?></td>
                    <td><?php echo $row['Cenauzgodniona']; ?></td>
                    <td><?php echo $row['Waluta']; ?></td>
