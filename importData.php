...
// Check connection
        ...
        $sql = "INSERT INTO members (Dokument, Kodtowaru, EAN, Nazwatowaru,
Iloscdorealizacji, Jednostka, Cenauzgodniona, Waluta) VALUES ('$Dokument,$Kod_towaru,$EAN,$Nazwa_towaru,$Ilosc_do_realizacji,
$Jednostka,$Cena_uzgodniona,$Waluta')";
...
//header("Location: index.php" . $qstring . '--->' . $Dokument.'--->'.$Kod_towaru);